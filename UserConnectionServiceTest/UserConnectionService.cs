...
namespace UserConnectionServiceTest
{
    [TestClass]
    public class UserConnectionService : IClassFixture<WebApplicationFactory<InvalidProgramException>>
    {
        ...
        public UserConnectionService(WebApplicationFactory<Program> factory = null)
        {
